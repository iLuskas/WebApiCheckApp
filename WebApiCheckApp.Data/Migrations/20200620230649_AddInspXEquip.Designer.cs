...
namespace WebApiCheckApp.Infrastruture.Data.Migrations
{
    ...
    [Migration("20200620230649_AddInspXEquip")]
    partial class AddInspXEquip
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiCheckApp.Domain.Models.EquipamentoInspecao", b =>
                {
                    ...
                    b.HasKey("InspecaoId", "EquipamentoId");

                    b.HasIndex("EquipamentoId");

                    b.ToTable("EquipamentoInspecao");
                });
            ...
            modelBuilder.Entity("WebApiCheckApp.Domain.Models.Inspecao", b =>
                {
                    ...
                    b.Property<string>("UtilmaRec_Insp")
                        .HasColumnType("nvarchar(50)")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("WebApiCheckApp.Domain.Models.EquipamentoInspecao", b =>
                {
                    b.HasOne("WebApiCheckApp.Domain.Models.Equipamento_Seguranca", "Equipamento")
                        .WithMany("EquipamentoInspecoes")
                        .HasForeignKey("EquipamentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApiCheckApp.Domain.Models.Inspecao", "Inspecao")
                        .WithMany("EquipamentoInspecoes")

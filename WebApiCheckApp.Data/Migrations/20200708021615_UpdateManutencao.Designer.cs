...
namespace WebApiCheckApp.Infrastruture.Data.Migrations
{
    ...
    [Migration("20200708021615_UpdateManutencao")]
    partial class UpdateManutencao
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiCheckApp.Domain.Models.AltaPressaoNv3", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("AprovadoCondenado")
                        .HasColumnType("bit");

                    b.Property<string>("CapMaxCarga")
                    ...
                    b.Property<string>("PressaoTeste")
                        .HasColumnType("nvarchar(50)")
                        .HasMaxLength(50);
                    ...
                    b.ToTable("AltaPressaoNv3");
                });

            modelBuilder.Entity("WebApiCheckApp.Domain.Models.BaixaPressaoNv3", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebApiCheckApp.Domain.Models.Manutencao", b =>
                {
                    ...
                    b.Property<DateTime>("UltimoTeste")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("WebApiCheckApp.Domain.Models.AltaPressaoNv3", b =>
                {
                    b.HasOne("WebApiCheckApp.Domain.Models.Manutencao", "Manutencao")
                        .WithOne("altaPressaoNv3")
                        .HasForeignKey("WebApiCheckApp.Domain.Models.AltaPressaoNv3", "ManutencaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WebApiCheckApp.Domain.Models.BaixaPressaoNv3", b =>
                {
                    b.HasOne("WebApiCheckApp.Domain.Models.Manutencao", "Manutencao")
                        .WithOne("baixaPressaoNv3")
                        .HasForeignKey("WebApiCheckApp.Domain.Models.BaixaPressaoNv3", "ManutencaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
